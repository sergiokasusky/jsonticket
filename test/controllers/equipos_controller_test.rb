...
class EquiposControllerTest < ActionController::TestCase
  ...
  test "should create equipo" do
    assert_difference('Equipo.count') do
      post :create, equipo: { cliente_id: @equipo.cliente_id, desc_corta: @equipo.desc_corta, hd: @equipo.hd, marca: @equipo.marca, modelo: @equipo.modelo, ram: @equipo.ram, serie: @equipo.serie }
    end
  ...
  test "should update equipo" do
    patch :update, id: @equipo, equipo: { cliente_id: @equipo.cliente_id, desc_corta: @equipo.desc_corta, hd: @equipo.hd, marca: @equipo.marca, modelo: @equipo.modelo, ram: @equipo.ram, serie: @equipo.serie }
    assert_redirected_to equipo_path(assigns(:equipo))
  end
